...
const token = 'NjM1MTg0MzU5NDk3NzkzNTU5.XatYpA.Er2enogDOdShLv8N3v_n34z4gDE';
...
bot.on('message', msg=>{
    if (msg.content.includes ("hungry")) {
        ...
        if (sanders === 1){
            msg.channel.send('If you need something to fill you up than try my Mac & Cheese $5 Fill Up from your local KFC https://www.kfc.com/ ');
...
bot.on('message' , msg=>{
    ...
    if(sanders === 1){
        msg.channel.send('The only thing here Disgusting are Furries unless one of you is a Chicken Furry which in that case your the perfect advertisment tool and I love advertisment!')
    };
};
});
